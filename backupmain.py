...
movieActor = "Matt Smith (Prince Daemon Targaryen)\n\
...
infoCanvas.create_window(25, 250, anchor="w", window=castLabel)
actorInfoValue = tk.Text(infoCanvas, wrap="word", width=75, height=50)
actorInfoValue.insert("1.0", movieActor)
actorInfoValue.configure(state="disabled")
infoCanvas.create_window(150, 800, anchor="w", window=actorInfoValue)
